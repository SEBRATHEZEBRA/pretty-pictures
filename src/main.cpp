...
int main()
{
    ...
    unsigned int VBO, VAO, EBO, VBOTwo, VAOTwo;
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(tOne), tOne, GL_STATIC_DRAW);
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(tTwo), tTwo, GL_STATIC_DRAW);
